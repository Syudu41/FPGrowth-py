...
def FPT_Miner(index_table, min_sup, prefix_path, fp_patrn_list):
  ...
  for item in new_index_:
    ...
    while current_node != None:
      ...
      cd_transactions = []
      for path, freq in prefix_paths_:
          for _ in range(freq):  # Add each path count times
